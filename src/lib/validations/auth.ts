...
export type AcceptInvitationFormData = z.infer<
...
export const authValidationHelpers = {
  ...
  safeValidateForgotPassword: (data: unknown) =>
    forgotPasswordFormSchema.safeParse(data),
  safeValidateResetPassword: (data: unknown) =>
    resetPasswordFormSchema.safeParse(data),
  safeValidateChangePassword: (data: unknown) =>
    changePasswordFormSchema.safeParse(data),
  safeValidateEmailVerification: (data: unknown) =>
    emailVerificationFormSchema.safeParse(data),
  safeValidateUpdateProfile: (data: unknown) =>
    updateProfileFormSchema.safeParse(data),
  safeValidateUserInvitation: (data: unknown) =>
    userInvitationFormSchema.safeParse(data),
  safeValidateAcceptInvitation: (data: unknown) =>
    acceptInvitationFormSchema.safeParse(data),
