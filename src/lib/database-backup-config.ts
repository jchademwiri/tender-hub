...
export const MONITORING_CONFIG = {
  ...
  performanceMetrics: [
    {
      name: "cpu_usage",
      query: "SELECT 100 - (avg_load) * 100 / count(*) FROM pg_stat_activity WHERE state = 'active';",
      unit: "percentage"
    },
    {
      name: "memory_usage", 
      query: "SELECT (total - available) * 100 / total FROM pg_tablespace WHERE spcname = 'pg_default';",
      unit: "percentage"
    },
    {
      name: "disk_io",
