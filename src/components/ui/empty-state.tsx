import { FileX, Plus, RefreshCw, Search } from "lucide-react";
...
export function EmptyState({
  ...
  if (variant === "compact") {
    return (
      <div
        className={cn(
          "flex items-center gap-3 p-4 text-sm text-muted-foreground",
          className,
        )}
      >
        {icon || defaultIcon}
    ...
    return (
      ...
      >
        <div className="flex justify-center mb-4">
          <div className="rounded-full bg-muted p-3">{icon || defaultIcon}</div>
        </div>
