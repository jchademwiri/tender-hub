...
const PasswordChangedEmail = (props: PasswordChangedEmailProps) => {
  const { userEmail = "hello@jacobc.co.za", changeDate = new Date().toLocaleDateString('en-US', {
    year: 'numeric',
    month: 'long',
    day: 'numeric',
    hour: '2-digit',
          ...
          <Container className="bg-white rounded-[8px] shadow-sm max-w-[600px] mx-auto">
            <Section className="p-[40px]">
              ...
              <Text className="text-[16px] text-gray-700 leading-[24px] mb-[24px] m-0">
                Your Tender Hub account password was recently changed on {changeDate}.
              </Text>
              ...
              <Section className="bg-red-50 border-l-[4px] border-red-400 p-[20px] mb-[32px] rounded-[4px]">
                ...
                <Text className="text-[14px] text-red-700 leading-[22px] m-0">
                  If you made this change, you can disregard this email. If you didn't change your password, please contact our support team immediately as your account may be compromised.
                </Text>
              </Section>
              ...
              <Text className="text-[14px] text-gray-600 leading-[20px] mb-[32px] m-0">
                If you need help or believe this was unauthorized, please contact us immediately at{' '}
